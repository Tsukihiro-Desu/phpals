                                        ...
                                        <div class="card-header"><strong>Edit Exam</strong> </div>
                                            <div class="card-body card-block">
                                                <div class="form-group"><label for="company" 
                                                    ...
                                                    New Exam Category</label><input type="text" 
                                                    name="examname" placeholder="Add Exam Category" 
                                                    class="form-control" value="<?php echo $exam_category; ?>">
                                                </div>
                                                <div class="form-group"><label for="vat" 
                                                    class=" form-control-label">
                                                    Examination Time in Minutes</label><input type="text" 
                                                    placeholder="Exam Time in Minutes" class="form-control" name="examtime" value="<?php echo $exam_time; ?>">
                                                </div>
